...
:root {
 ...
 --neon-bunny-symbol: var(--neon-bunny-pink);
 --neon-bunny-title-class-inherited: var(--neon-bunny-title);
 --neon-bunny-title-class: var(--neon-bunny-green-neon);
 --neon-bunny-title-function-invoke: var(--neon-bunny-title);
 --neon-bunny-title-function: var(--neon-bunny-green-neon);
 --neon-bunny-title: var(--neon-bunny-title);
 --neon-bunny-type: var(--neon-bunny-pink);
 --neon-bunny-variable-constant: var(--neon-bunny-variable);
 --neon-bunny-variable-language: var(--neon-bunny-blue-light);
 --neon-bunny-variable: var(--neon-bunny-green-darker);
 /* ------------------------- Meta */
 --neon-bunny-meta-keyword: var(--neon-bunny-green);
 --neon-bunny-meta-prompt: var(--neon-bunny-meta);
 --neon-bunny-meta-string: var(--neon-bunny-meta);
 --neon-bunny-meta: var(--neon-bunny-blue-light);
 /* ------------------------- Tags, attributes, configs */
 --neon-bunny-attr: var(--neon-bunny-green);
 --neon-bunny-attribute: var(--neon-bunny-attr);
 --neon-bunny-name: var(--neon-bunny-blue-light);
 --neon-bunny-section: var(--neon-bunny-attr);
...
.hljs.language-javascript .hljs, .hljs.language-js .hljs {
 /* ------------------------- General purpose */
 /* ------------------------- Meta */
 /* ------------------------- Tags, attributes, configs */
 /* ------------------------- Text Markup */
