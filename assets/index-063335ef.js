...
/>`,a=`<CodeBlock
  ...
  :tabs="false"
/>`;return(r,o)=>{const i=Ue("CodeBlock");return J(),Z("div",null,[df,c("div",pf,[c("div",mf,[j(i,{code:n,label:"Visible on hover",lang:"html",tabs:!1,theme:T(t)},null,8,["theme"])])]),c("div",bf,[c("div",hf,[j(i,{code:a,label:"Persistent Copy Button",lang:"html","persistent-copy-button":"",tabs:!1,theme:T(t)},null,8,["theme"])])])])}}},ls=`
/**
 * MIT License
...
createApp()
  .use(CodeBlock)
  .mount('#app');`;return(r,o)=>{const i=Ue("CodeBlock");return J(),Z("div",mp,[c("div",{class:ve(T(t).h2ColClass)},hp,2),c("div",gp,[j(i,{code:a,label:"",lang:"javascript","show-run":!1,theme:T(n)},null,8,["theme"])])])}}},yp={class:"row mb-5"},_p=c("h2",null,"Usage",-1),wp=[_p],kp={class:"col-12"},xp={class:"col-12"},Cp={__name:"UsageSection",setup(e){const t=ae("styleData"),n=ae("selectedTheme"),a=`<template>
  <CodeBlock
    :code="myCode"
    label="My Code"
    lang="html"
...
<script setup>
  ...
  alert(foo);
<\/script>`;function o(){alert("bar")}return(i,s)=>{const l=Ue("CodeBlock");return J(),Z("div",yp,[c("div",{class:ve(T(t).h2ColClass)},wp,2),c("div",kp,[j(l,{code:a,label:"My Code",lang:"html","show-run":!1,theme:T(n)},null,8,["theme"])]),c("div",xp,[j(l,{code:r,label:"Run My Code",lang:"html","run-tab":"",tabs:"",theme:T(n),onRun:o},null,8,["theme"])])])}}};var ir=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},sr={},Ap={get exports(){return sr},set exports(e){sr=e}};(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
