...
const Fl = { class: "v-code-block--button-copy" }, ql = { class: "v-code-block--button-run" }, Wl = { class: "v-code-block--code" }, Gl = ["textContent"], Zl = ["innerHTML"], Kl = Eo({ __name: "CodeBlock", props: function(n, e) {
  ...
  let l;
  const s = ln(null), r = ln("copy"), i = ln(""), c = ln(!1), p = ln(!1), u = ln(!1), f = ln("https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.8.0/build/styles"), E = ln("https://cdn.jsdelivr.net/gh/PrismJS/prism@1.29.0/themes"), T = ln("https://cdn.jsdelivr.net/gh/PrismJS/prism-themes@1.9.0/themes"), N = ln(""), L = ln(""), $ = ln(""), nn = jn(() => {
    let b = "";
